<div class="dashboard-content-container" style='width: 97% !important'>
    <div class="dashboard-content-inner" >
        ...
        @if(session('opTestA')=='all' || session('opTestA')=='')
                ...
                <div class="col-xl-12">
                    <div class="dashboard-box margin-top-0">
                        ...
                        <div class="headline d-flex justify-content-between col-12">
                            <h3><i class="icon-material-outline-question-answer"></i> {{ $count }} Test</h3>
                        </div>
                        <div class="content">
                                    ...
                                    <div class="freelancer-overview manage-candidates">
                                        <div class="freelancer-overview-inner">
                                            ...
                                            <div class="freelancer-name">
                                                ...
                                                @if($item->type=='admin')
                                                    <span class="freelancer-detail-item"><i class="icon-feather-user"></i> {{$item->user()->first()->nomUtilisateur}}</span>
                                                    <span class="freelancer-detail-item text-capitalize"><i class="icon-material-outline-settings"></i>Par  {{$item->type}}</span>
                                                @elseif($item->type=='entreprise')
              ...
              <div class="d-flex justify-content-center margin-top-25">
                <div class="account-type col-xl-5 offset-xl-3">
                    <div>
                        ...
                        <label for="freelancer-radio" class="ripple-effect-dark"><i class="icon-material-outline-rate-review"></i> Test</label>
                    </div>
                    ...
                    <div>
                        ...
                        <label for="employer-radio" class="ripple-effect-dark"><i class="icon-material-outline-question-answer"></i> question</label>
                    </div>
                </div>
              </div>
                @if($typeUpdate=='test')
                                            ...
                                            <div class="row">
                                                <div class="col-xl-12">
                                                    <div class="submit-field">
                                                        <h5>titre</h5>
                                                        <input type="text" class="with-border" wire:model.defer='titre' >
                                                    </div>
                                                </div>
                                                <div class="col-xl-12">
                                                    <div class="submit-field">
                                                        <h5>Duree <span>(minute)</span></h5>
                                                        <input type="text" class="with-border" wire:model.defer='duree' >
                                                    </div>
                                                </div>
                                                <div class="col-xl-12">
                                                    <div class="submit-field">
                                                        <h5>test Description</h5>
                                                        <textarea cols="30" rows="5" class="with-border" wire:model.defer='description' placeholder="Entrez la description de test"></textarea>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                ...
                @endif
                  <center>
                    <div align='center' class="centered-button margin-top-35 col-xl-4 col-md-4">
                        <button wire:click='change("all")' type='button' class="button ripple-effect button-sliding-icon margin-bottom-35"><i class="icon-material-outline-arrow-back"></i>Annuler</button>
                    <button wire:click='updateTb' class='button ripple-effect button-sliding-icon margin-bottom-35'>modifier<i class='icon-feather-check'></i></button>
                    </div>
                  </center>
                </div
        ...
        @elseif(session('opTestA')=='ajouteTest')
            <div class="col-xl-12" >
                <div class="dashboard-box margin-top-0">
                    ...
                    <div class="content with-padding padding-bottom-10">
                        <div class="row">
                            ...
                            <div class="col-xl-4">
                                <div class="submit-field">
                                    <h5>Titre Test</h5>
                                    <input type="text" class="with-border" wire:model.defer='titre' placeholder="entrez le titre de test">
                                    @error('titre')
                            ...
                            <div class="col-xl-4">
                                <div class="submit-field">
                                    <h5>Duree Test  <span>(minute)</span></h5>
                                    <input type="text" class="with-border" wire:model.defer='duree' placeholder="Entrez la duree de test">
                                    @error('duree')
                                    <span class="text-danger">{{$message }}</span>
                                @enderror
                                </div>
                            ...
                            <div class="col-xl-4">
                                <div class="submit-field">
                                    ...
                                    <select wire:model='type' >
                                        <option value=''>Entrez le type de type</option>
                            ...
                            @if($type=='entreprise')
                                <div class="col-xl-4">
                                    <div class="submit-field">
                                        <h5>Entreprise</h5>
                                        <select wire:model='identreprise'>
                                            {!! isset($identreprise)?'':"<option>selectionez le nom d'entreprise</option>" !!}
                                ...
                                @if(isset($secteurEntreprise))
                                <div class="col-xl-4">
                                    <div class="submit-field">
                                        <h5>secteur
                                        {!! count($secteurEntreprise)>0==true?'':"<span class='text-danger'>(eroure)</span>" !!}
                                    </h5>
                                        @if(count($secteurEntreprise)>0==true)
                                            <select wire:model='idsecteur'>
                                            <option>selectionez le nom</option>
                                            @foreach ($secteurEntreprise as $item)
                                    ...
                                    <input type="text" class="with-border" placeholder="entrez la duree de test" value='no secteur' readonly style="border:2px solide red !important">
                                        @endif
                                    </div>
                                </div>
                                @endif
        ...
        @elseif(session('opTestA')=='delete')
            ...
            <div class="dashboard-box margin-top-0">
                <div class="headline d-flex justify-content-between">
                    <h3><i class="icon-material-outline-rate-review"></i> supprimer Test</h3>
                </div>
                    <center>
        ...
        @elseif(session('opTestA')=='details')
            <div class="d-flex dd">
            <div class="col-xl-6">
                <div class="dashboard-box margin-top-0">
                                    ...
                                    <div >
                                        <div class="row">
                                            ...
                                            <div class="col-xl-12">
                                                <div class="submit-field">
                                                    <h5>Type</h5>
                                                    <input type="text" class="with-border" wire:model='type' disabled>
                                                </div>
                                            </div>
                                            @if($type=='admin')
                                                <div class="col-xl-12">
                                                    <div class="submit-field">
                                                        <h5>Utilisateur</h5>
                                                        <input type="text" class="with-border" wire:model='idutilisateur' disabled>
                                                    </div>
                                                </div>
            ...
            <div' class="centered-button margin-top-35 col-xl-4 col-md-4">
            <center><button type='button' wire:click='change("all")' class="button ripple-effect button-sliding-icon"><i class="icon-material-outline-arrow-back"></i>Annuler</button></center>
            </div>
        @elseif(session('opTestA')=='ajouteQuestion')
            <div class="col-xl-12" >
                <div class="dashboard-box margin-top-0">
                    ...
                    <div class="content with-padding padding-bottom-10">
                        <div class="row">
                            <div class="col-xl-4">
                                <div class="submit-field">
                                    <h5>Test</h5>
                                    <select wire:model.defer='choixtest'>
                                        <option>Entrez votre choix</option>
                                        @forelse ($testA as $item)
                            ...
                            <div class="col-xl-4">
                                <div class="submit-field">
                                    <h5>Question</h5>
                                    <input type="text" class="with-border" wire:model.defer='questions' placeholder="entrez la question">
                                @error('questions')
                                <span class="text-danger">{{$message }}</span>
                                    @enderror
                                    </div>
                            ...
                            <div class="col-xl-4">
                                <div class="submit-field">
                                    <h5>choix 1</h5>
                                    <input type="text" class="with-border" wire:model.defer='choix1' placeholder="entrez le choix 1">
                                    @error('choix1')
                                    <span class="text-danger">{{$message }}</span>
                                    @enderror
                                </div>
                            ...
                            <div class="col-xl-4">
                                <div class="submit-field">
                                    <h5>choix 2</h5>
                                    <input type="text" class="with-border" wire:model.defer='choix2' placeholder="entrez le choix 2">
                                    @error('choix2')
                                    <span class="text-danger">{{$message }}</span>
                                    @enderror
                                </div>
                            ...
                            <div class="col-xl-4">
                                <div class="submit-field">
                                    <h5>choix 3</h5>
                                    <input type="text" class="with-border" wire:model.defer='choix3' placeholder="entrez le choix 3">
                                    @error('choix3')
                                    <span class="text-danger">{{$message }}</span>
                                    @enderror
                                </div>
                            ...
                            <div class="col-xl-4">
                                <div class="submit-field">
                                    <h5>choix 4</h5>
                                    <input type="text" class="with-border" wire:model.defer='choix4' placeholder="entrez le choix 4">
                                    @error('choix4')
                                    <span class="text-danger">{{$message }}</span>
                                    @enderror
                                </div>
                            ...
                            <div class="col-xl-4">
                                <div class="submit-field">
                                    <h5>Choix correct</h5>
                                    <select wire:model.defer='iscorect'>
